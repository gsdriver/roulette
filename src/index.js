...
{
    var speech = "Welcome to the Alexa Skills Kit, you can say hello";
    var reprompt = "You can say hello";
    ...
    var response = buildResponse(speech, false, reprompt);
...
function onIntent(intentRequest, context)
{
    ...
    switch (intentRequest.intent.name)
    {
        case "HelloWorldIntent":
            ...
            response = buildResponse("Hello World!", true, null);
            context.succeed(response);
            break;
