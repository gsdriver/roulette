...
const resources = {
  ...
  'LEADER_AMERICAN_RANKING': 'Your current bankroll of £{0} ranks you as <say-as interpret-as="ordinal">{1}</say-as> of {2} players on a double zero American wheel. ',
  'LEADER_EUROPEAN_RANKING': 'Your current bankroll of £{0} ranks you as <say-as interpret-as="ordinal">{1}</say-as> of {2} players on a single zero European wheel. ',
