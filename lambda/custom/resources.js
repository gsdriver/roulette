...
const german = {
  ...
  // From Help.js
  'HELP_REPROMPT': 'Womit kann ich dir noch helfen?',
  'HELP_CHECK_APP': 'Über die Alexa Companion App kannst du erfahren, welche Wetten du platzieren kannst. ',
  ...
  'HELP_SPIN_WITHBETS': 'Sag Dreh das Rad, um zu spielen oder Lies die hohen Punktzahlen vor, um die Rangliste zu hören. Über die Alexa Companion App kannst du erfahren, welche weiteren Wetten du platzieren kannst. ',
  'HELP_SPIN_LASTBETS': 'Sag Dreh das Rad, um die gleichen Wetten wie beim letzten Mal zu spielen oder Lies die hohen Punktzahlen vor, um die Rangliste zu hören. Über die Alexa Companion App kannst du erfahren, welche neuen Wetten du platzieren kannst. ',
...
const spanish = {
  ...
  // From Help.js
  'HELP_REPROMPT': '¿Qué más se te ofrece?',
  'HELP_CHECK_APP': 'Usa la aplicación de Alexa, la asistente de voz, para conseguir la lista completa de las apuestas que puedes hacer. ',
  ...
  'HELP_SPIN_WITHBETS': 'Di "gira la ruleta" para jugar o di "puntajes altos" para oír el marcador. Usa la aplicación de Alexa, la asistente de voz, para conseguir la lista completa de las apuestas que puedes hacer. ',
  'HELP_SPIN_LASTBETS': 'Di "gira la ruleta" para jugar con las mismas apuestas de la última vez o di "puntajes altos" para oír el marcador. Usa la aplicación de Alexa, la asistente de voz, para conseguir la lista completa de las apuestas que puedes hacer. ',
